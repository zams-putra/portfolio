    ...
    >
      ...
      <div className="p-5 flex flex-col gap-3 flex-1">
        ...
        <div className="mt-auto flex items-center justify-between pt-3 border-t border-slate-800">
          ...
          <span className={`text-xs font-mono ${style.text} opacity-0 group-hover:opacity-100 transition-opacity`}>
            open →
          </span>
        </div>
      </div>
...
export default function Blog() {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {activePost && <MarkdownModal post={activePost} onClose={() => setActivePost(null)} />}
      </AnimatePresence>
    </>
  );
}